...
**/
class qPanels : public QObject, public ccStdPluginInterface
{
	Q_OBJECT
	...
	Q_PLUGIN_METADATA( IID "cccorp.cloudcompare.plugin.Panels" FILE "../info.json" )

public:
	explicit qPanels ( QObject *parent = nullptr );
	~qPanels () override = default;
